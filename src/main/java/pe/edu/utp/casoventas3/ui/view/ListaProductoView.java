...
public class ListaProductoView extends javax.swing.JDialog implements MVPView {
    ...
    public ListaProductoView(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
    ...
    private void initComponents() {
        ...
        tbl1.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "Codigo", "Descripcion", "Precio Unit."
            }
        ) {
